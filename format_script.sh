#sudo apt-get install vim curl mysql-server-5.7 python-pip python3-pip python-dev python3-dev libmysqlclient-dev git

#mkdir ~/.vim
#git clone https://github.com/VundleVim/Vundle.vim.git ~/.vim/bundle/Vundle.vim

#sudo pip install flask flake8 virtualenv virtualenvwrapper
