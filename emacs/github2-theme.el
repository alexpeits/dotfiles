...
;;;;; basic coloring
   ...
   `(default ((t (:foreground ,github2-text :background ,github2-white))))
...
;;;;; org-mode
   ...
   `(org-level-1 ((t (:foreground ,github2-text))))
   `(org-level-2 ((t (:foreground ,github2-constant))))
   `(org-level-3 ((t (:foreground ,github2-constant))))
