"highlight pythonClass ctermfg=3 guifg=#FFC37D
...
highlight WildMenu ctermbg=2 ctermfg=236 cterm=bold guibg=#111111 gui=bold
highlight MatchParen ctermbg=237 ctermfg=180 cterm=underline guibg=#3A3A3A guifg=#D7AF87 gui=underline
highlight IncSearch cterm=none ctermbg=173 ctermfg=234 guibg=#d7875f guifg=#1c1c1c
highlight Boolean ctermfg=4
highlight Constant ctermfg=4
highlight Delimiter ctermfg=4
highlight SpecialChar ctermfg=4
highlight SpellBad cterm=underline ctermbg=237 guibg=#3A3A3A gui=underline
